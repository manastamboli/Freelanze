...
function RecuriterMarket() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-bold mb-4">Popular Projects</h3>
        <div className="grid grid-cols-5 gap-4 mb-8">
          {displayCards().map((card) => (
            <div
              key={card.id}
      ...
      {/* Freelancer Section */}
      <div className="mb-8">
        <h3 className="text-2xl font-bold mb-4">Top Freelancers</h3>
        <div className="grid grid-cols-5 gap-4 mb-8">
          {freelancers.map((freelancer) => (
            <div
              ...
              />
              <h4 className="text-lg font-bold mb-2">{freelancer.name}</h4>
              <div className="flex flex-wrap gap-2 mb-2">
...
export default RecuriterMarket;